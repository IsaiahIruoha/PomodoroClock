  ...
  return (
    <>
      ...
      <div id="length-display">
        <h2 id="timer-label">{mode ? "Break" : "Session"}</h2>
        <audio
          id="beep"
        ...
        <div class="timerButtons">
          <div id="start_stop" onClick={() => setPaused(!paused)}>
            {paused ? (
              <svg viewBox="0 0 512 512" width="50" title="play-circle">
                <path d="M256 8C119 8 8 119 8 256s111 248 248 248 248-111 248-248S393 8 256 8zm115.7 272l-176 101c-15.8 8.8-35.7-2.5-35.7-21V152c0-18.4 19.8-29.8 35.7-21l176 107c16.4 9.2 16.4 32.9 0 42z" />
              </svg>
            ) : (
              <svg viewBox="0 0 512 512" width="50" title="pause-circle">
...
const Session = (props) => {
  ...
  return (
    <div id="session-container" class="adjustmentBox">
...
const Break = (props) => {
  ...
  return (
    <div id="break-container" class="adjustmentBox">
      ...
      <div class="timerButtons">
        ...
        <p id="break-length">{props.downtime}</p>
        <svg
          onClick={() => {
            if (props.paused) {
              props.setDowntime(
